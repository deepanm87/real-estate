...
export function ListingForm({
  ...
  const [location, setLocation] = useState<GeoPoint | undefined>(listing?.location)
  ...
  const form = useForm<FormDataInput, unknown, FormDataOutput>({
    ...
    defaultValues: {
      ...
      propertyType: (listing?.propertyType as FormDataOutput["propertyType"]) || "house",
