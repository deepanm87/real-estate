...
export const metadata: Metadata = {
  ...
  description: "Find your perfect home from our curated selection of properties. Filter by price, bedrooms, location, and more."
}
      ...
      <div className="bg-background border-b border-border/50">
        <div className="container py-8">
          ...
          >
            ...
            <span className="text-foregroundn font-medium">Properties</span>
          </nav>
          <h1 className="text-3xl md:text-4xl font-bold font-heading">
            Browse Properties
          </h1>
          <p className="text-muted-foreground mt-2">
            Find your perfect home from our curated selection
          </p>
        </div>
      </div>
            ...
            <Tabs defaultValue="list" className="w-full">
              ...
              <TabsContent value="list" className="mt-0">
                {properties && properties.length > 0 ? (
                  ...
                  <div className="text-center py-16 background rounded-2xl border border-border/50">
